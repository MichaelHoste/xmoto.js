...
(function() {
  var Assets, Blocks, Entities, Infos, LayerOffsets, Level, Limits, Moto, Physics, Script, Sky, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2DebugDraw, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2PrismaticJointDef, b2Vec2, b2World, disable_scroll, keydown, keys, preventDefault, triangulate;
  ...
  Moto = (function() {
    ...
    Moto.prototype.init = function() {
      ...
      this.bike_body = this.create_bike_body();
      this.left_wheel = this.create_wheel(this.player_start.x - 0.7, this.player_start.y + 0.45);
      return this.right_wheel = this.create_wheel(this.player_start.x + 0.7, this.player_start.y + 0.45);
    };

    Moto.prototype.create_bike_body = function() {
      ...
      bodyDef.position.x = this.player_start.x / this.scale;
      bodyDef.position.y = (this.player_start.y + 1.0) / this.scale;
    ...
    Moto.prototype.create_joints = function() {
      var jointDef;
      jointDef = new b2PrismaticJointDef();
      jointDef.Initialize(this.bike_body, this.left_wheel, this.bike_body.GetWorldCenter(), {
        x: -0.15,
        y: -0.15
      });
