...
(function() {
  ...
  Level = (function() {
    ...
    Level.prototype.display = function() {
      ...
      this.particles.display(this.ctx);
      if (Constants.debug) {
  ...
  Particles = (function() {
    ...
    Particles.prototype.display = function(ctx) {
      var particle, position, _i, _len, _ref, _results;
      _ref = this.list;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        particle = _ref[_i];
