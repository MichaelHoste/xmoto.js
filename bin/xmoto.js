  ...
  Blocks = (function() {
    ...
    Blocks.prototype.init_sprites = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        results.push(this.level.camera.container2.addChild(block.sprite));
      }
      return results;
    };
  ...
  Edges = (function() {
    ...
    Edges.prototype.init_sprites = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        results.push(this.level.camera.container2.addChild(edge.sprite));
      }
      return results;
    };
  ...
  Entities = (function() {
          ...
          if (entity.frames === 0) {
            ...
            results.push((function() {
              ...
              for (i = k = 0, ref1 = entity.frames - 1; 0 <= ref1 ? k <= ref1 : k >= ref1; i = 0 <= ref1 ? ++k : --k) {
                results1.push(this.assets.anims.push(frame_name(entity, i)));
              }
              return results1;
            }).call(this));
          }
    ...
    Entities.prototype.display = function(entity) {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        entity = ref[j];
        if (entity.sprite) {
          results.push(entity.sprite.visible = visible_entity(entity));
        } else {
          results.push(void 0);
        }
      }
  ...
  Ghost = (function() {
    ...
    Ghost.prototype.move_with_key_step = function() {
      ...
      if (key_step) {
        ...
        for (k = 0, len1 = ref1.length; k < len1; k++) {
          part = ref1[k];
          results.push(set_part_position(this.moto.rider, part, key_step));
        }
        return results;
      }
    };
  ...
  Replay = (function() {
    ...
    Replay.prototype.add_key_steps = function() {
      ...
      if (this.steps % Constants.replay_key_step === 0) {
        ...
        for (k = 0, len1 = ref1.length; k < len1; k++) {
          part = ref1[k];
          results.push(key_step[part] = physics_values(rider[part]));
        }
        return results;
      }
    };
  ...
  Rider = (function() {
    ...
    Rider.prototype.init_sprites = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        this[part + "_sprite"] = new PIXI.Sprite.fromImage(this.assets.get_url(asset_name));
        results.push(this.level.camera.container2.addChild(this[part + "_sprite"]));
      }
      return results;
    };
