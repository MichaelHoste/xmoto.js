...
// Reassign correct position + velocity values
  ...
  Assets = class Assets {
    ...
    load(callback) {
      var item, items, l, len, len1, len2, len3, m, o, q, ref, ref1, ref2, ref3, urls;
      items = [];
      ref = this.textures;
      for (l = 0, len = ref.length; l < len; l++) {
        item = ref[l];
