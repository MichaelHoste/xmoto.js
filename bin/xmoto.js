...
(function() {
  var Assets, Blocks, Entities, Infos, Input, LayerOffsets, Level, Limits, Moto, Physics, Script, Sky, angle_between_points, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2DebugDraw, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2PrismaticJointDef, b2RevoluteJointDef, b2Settings, b2Vec2, b2World, rotate_point, triangulate;
  ...
  Moto = (function() {
    ...
    Moto.prototype.display_left_axle = function() {
      var a, angle, axle_thickness, b, distance, left_axle_adjusted_position, left_axle_position, left_wheel_position;
      axle_thickness = 0.09;
      ...
      left_axle_adjusted_position = rotate_point(left_axle_position, this.bike_body.GetAngle(), this.position());
  ...
  angle_between_points = function(point1, point2) {
    var adj, angle, opp;
  ...
  rotate_point = function(point, angle, rotation_axe) {
    var new_point;
    return new_point = {
