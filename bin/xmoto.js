...
(function() {
  ...
  Level = (function() {
    ...
    Level.prototype.load_replay = function() {
      ...
      return this.replayPlayer = new Ghost(this, replayFile.clone(this));
    };
    ...
    Level.prototype.display = function(debug) {
      ...
      if (this.replayPlayer) {
        this.ctx.translate(-this.replayPlayer.position().x, -this.replayPlayer.position().y - 0.25);
      } else {
    ...
    Level.prototype.rewind = function(x) {
      if (this.replayPlayer) {
        ...
        if (this.replayPlayer.current_frame < 0) {
          return this.replayPlayer.current_frame = 0;
        }
      }
    };
