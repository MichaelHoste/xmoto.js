...
(function() {
  var Assets, Blocks, Entities, Infos, Input, LayerOffsets, Level, Limits, Moto, Physics, Script, Sky, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2DebugDraw, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2PrismaticJointDef, b2RevoluteJointDef, b2Settings, b2Vec2, b2World, getElementAngle, triangulate;
  ...
  Moto = (function() {
    ...
    Moto.prototype.display_left_axle = function() {
      var a, angle, b, distance, left_axle_position, left_wheel_position;
      ...
      angle = (getElementAngle(left_axle_position.x, left_axle_position.y, left_wheel_position.x, left_wheel_position.y) + 90) * Math.PI / 180.0;
      this.level.ctx.save();
  ...
  getElementAngle = function(x1, y1, x2, y2) {
    var adj, angle, opp;
    adj = x2 - x1;
    opp = y2 - y1;
