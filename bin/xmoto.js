...
(function() {
  var Assets, Blocks, Camera, Constants, Edges, Entities, Ghost, Ghosts, Infos, Input, Layers, Level, Limits, Listeners, Math2D, Moto, MotoFlipService, Particles, Physics, Replacements, Replay, ReplayConversionService, Rider, Script, Sky, Theme, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2Contact, b2DebugDraw, b2EdgeChainDef, b2EdgeShape, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2PrismaticJointDef, b2RevoluteJointDef, b2Settings, b2Vec2, b2World, bind_debug_button, bind_delete_params_buttons, create_form_with_url_params, display_constants, override_constants_by_url_params;
      ...
      constructor(level) {
        ...
        if (!b2Contact.prototype._original_ComputeTOI) {
          ...
          b2Contact.prototype.ComputeTOI = function(sweepA, sweepB) {
            ...
            return this._original_ComputeTOI(sweepA, sweepB);
          };
        }
...
// assign each couple of vertices to a line
    ...
    Physics.MAX_TOI_CALLS_PER_STEP = 1000;
