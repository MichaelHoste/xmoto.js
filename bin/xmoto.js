...
(function() {
  ...
  Camera = (function() {
    ...
    Camera.prototype.init = function() {
      ...
      this.frame.alpha = 0.2;
      this.container2.addChild(this.frame);
    ...
    Camera.prototype.move = function() {
      ...
      if (Constants.automatic_scale) {
        ...
        this.offset.y = this.offset.y * 0.99 + velocity.y / 3.0 * 0.01;
      }
    ...
    Camera.prototype.display = function() {
      ...
      if (Constants.debug) {
        ...
        this.container.x = this.options.width / 2;
        this.container.y = this.options.height / 2;
        ...
        this.frame.drawRect(-size_x / 2, -size_y / 2, size_x, size_y, 0.1);
        this.frame.x = this.target().x;
        return this.frame.y = -this.target().y;
      }
    };
    ...
    Camera.prototype.target = function() {
      ...
      return adjusted_position = {
        ...
        y: position.y + this.offset.y + 0.25
      };
    };
  ...
  Blocks = (function() {
    ...
    Blocks.prototype.display = function() {
      var block, _i, _len, _ref;
      if (Constants.debug) {
        return false;
      }
  ...
  Edges = (function() {
    ...
    Edges.prototype.display = function() {
      var edge, _i, _len, _ref, _results;
      _ref = this.list;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        edge = _ref[_i];
        _results.push(edge.sprite.visible = this.visible(edge));
      }
      return _results;
    };
  ...
  Entities = (function() {
    ...
    Entities.prototype.display = function(entity) {
  ...
  visible_entity = function(entity) {
