...
(function() {
  var Assets, Blocks, Infos, Level, Limits, Physics, Sky, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2DebugDraw, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2Vec2, b2World;
  ...
  Level = (function() {
    ...
    Level.prototype.draw = function() {
      var canvas, canvas_height, canvas_width, entity, image, param, translate, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results;
      canvas = $('#game').get(0);
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        ...
        if (entity.type_id === 'EndOfLevel') {
          ...
          this.ctx.scale(1, -1);
          this.ctx.drawImage(this.assets.get('flower00'), 0, 0, entity.size.r * 4, -entity.size.r * 4);
