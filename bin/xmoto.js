  ...
  Physics = (function() {
    class Physics {
      ...
      draw_debug() {
        ...
        results = [];
        while (joint) {
          this.draw_debug_joint(joint, ctx);
      ...
      draw_debug_body(body, ctx) {
        ...
        results = [];
        while (fixture) {
          this.draw_debug_shape(fixture.getShape(), body, color, ctx);
