...
(function() {
  var Assets, Blocks, Buffer, Camera, Constants, Edges, Entities, Ghost, Ghosts, Infos, Input, LayerOffsets, Level, Limits, Listeners, Math2D, Moto, MotoFlipService, Particles, Physics, Replay, ReplayConversionService, Rider, Script, Sky, Theme, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2ContactListener, b2DebugDraw, b2EdgeChainDef, b2EdgeShape, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2PrismaticJointDef, b2RevoluteJointDef, b2Settings, b2TestOverlap, b2Vec2, b2World, bind_debug_button, bind_delete_params_buttons, block_AABB, create_form_with_url_params, display_constants, edge_AABB, entity_AABB, frame_name, override_constants_by_url_params, sort_blocks_by_texture, visible_block, visible_edge, visible_entity;
  ...
  Listeners = (function() {
    ...
    Listeners.prototype.init = function() {
      ...
      return listener.BeginContact = function(contact) {
  ...
  Physics = (function() {
    ...
    Physics.create_shape = function(fix_def, shape, mirror) {
      ...
      return fix_def.shape.Set(b2vertices, b2vertices.length);
    };
  ...
  visible_block = function(zone, block) {
    return b2TestOverlap(block.aabb, zone.aabb);
  };
  ...
  visible_edge = function(zone, edge) {
    return b2TestOverlap(edge.aabb, zone.aabb);
  };
  ...
  visible_entity = function(zone, entity) {
    return entity.display && b2TestOverlap(entity.aabb, zone.aabb);
  };
  ...
  Replay = (function() {
    ...
    Replay.prototype.clone = function() {
      var key, new_replay, _i, _len, _ref;
