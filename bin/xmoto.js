...
(function() {
  var Assets, Blocks, Infos, Level, Physics, Sky, b2AABB, b2Body, b2BodyDef, b2CircleShape, b2DebugDraw, b2Fixture, b2FixtureDef, b2MassData, b2MouseJointDef, b2PolygonShape, b2Vec2, b2World;
  ...
  Level = (function() {
    ...
    Level.prototype.draw = function() {
      ...
      this.ctx.closePath();
      this.ctx.save();
      this.ctx.scale(1.0 / this.scale.x, 1.0 / this.scale.y);
